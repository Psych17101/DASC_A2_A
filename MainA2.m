...
%% thoughts, data from crippling file
% 
% 
% area_stiff=5*6.096e-05; %area of the stiffeners
% area_skin=0.00036576;
% totarea=(area_skin+area_stiff);
% ar=area_skin/totarea;
% 
% E_stiff=6.2046e+10;
% E_skin=4.504e+10;
% 
% EA_skin=area_skin*E_skin;
% EA_stiff=area_stiff*E_stiff;
% 
% lr=EA_skin/(EA_skin+EA_stiff); %this is the original percentage of loading into the skin
% F_skin=lr*7e3;
% F_stiff=1-F_skin;
% 
% %now we assume that we increase the thickness of the skin with 25% (adding
% % one layer, for example, +45 -45, this leads to PB=0.8 (no buckling)
% 
% area_skin_new=1.25*area_skin;
% E_skin_new=4.0574e+10;
% EA_new=area_skin_new*E_skin_new;
% 
% % so to reduce the weight, the area of the stiffeners (which will be four),
% % has to become:
% 
% decrease=1-(totarea-area_skin_new)/area_stiff; %=30%
% 
% % this means that the new stiffener areas will have to increase with 4%
% 
% area_stiff_new=4*4.0958e-5;
% totarea_new=area_stiff_new+area_skin_new;
% weightratio=totarea_new/totarea;
